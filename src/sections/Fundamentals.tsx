	...
	return (
		<section className={'flex flex-col gap-12 px-4 home-section'} id="fundamentals">
			...
			<div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
				<FundamentalElement
					title="Supply Limit"
					description="The asymptotical (hard) limit on the token supply is 42 million coins. The concrete number is irrelevant, instead the fact that this limit exists is the relevant feature. It guarantees that once you own a share of the supply, that share will never shrink."
					icon={<LucideCoins className="h-8 w-8 text-white" />}
				/>
				<FundamentalElement
					title="Premine"
					description="1.98% (831,488 coins) were premined to raise funds for bootstrapping the project and supporting initial development. The remaining supply will be mined competitively through proof-of-work by participants who purchase tokens at market prices, earning rewards in return for securing the network."
