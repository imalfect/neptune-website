...
{<ArticleImage src="/article-images/blog/node-types-plot.svg" type="table" centered={true} alt="Node types plot" />}
...
{<ArticleImage src="/article-images/blog/reorganization-light.svg" type="table" centered={true} alt="Light node reorganization" />}
...
{<ArticleImage src="/article-images/blog/reorganization-archival.svg" type="table" centered={true} alt="Archival node reorganization" />}
...
{<ArticleImage src="/article-images/blog/reorganization-full-success.svg" type="table" centered={true} alt="Full node reorganization success" />}
...
{<ArticleImage src="/article-images/blog/reorganization-full-failure.svg" type="table" centered={true} alt="Full node reorganization failure" />}
