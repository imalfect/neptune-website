...
[^5]: The `receiver_digest` field does *not* identify the recipient (or in this case,
      the miner); instead, it is a requirement of the [mutator set](/articles/mutator-sets) which serves 
...
[^6]: The distribution 75%-25% is outdated. As of
      [mainnet launch](/articles/mainnet-launch), the actual distribution is
      50%-50%.
