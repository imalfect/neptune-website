...
Triton is a Turing-complete virtual machine with fast recursive [zk-STARK](https://neptune.cash/articles/stark-anatomy-index) verification as its primary design goal.
