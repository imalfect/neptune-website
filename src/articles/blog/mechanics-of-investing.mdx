...
The genesis block will mint 831'600 Neptune tokens, corresponding to 1.98% of the asymptotical limit on the token supply (42'000'000). Every three years, half of the remaining supply is mined competitively. See the [tokenomics](/articles/tokenomics) page for more details.
