...
| ![A mutator set using MMRs](/article-images/blog/mutator-set-midjourney-medium.png) |
|:-----------------------------------------------------------------------------------:|
...
| ![A mutator set using MMRs](/article-images/blog/mutator-set.svg) |
|:--:|
...
| ![Transparent ledger fragment](/article-images/blog/transparent-ledger.svg) |
|:--:|
| **Fig. 3: Fragment of a transparent ledger.** |

| ![Opage ledger fragment](/article-images/blog/opaque-ledger.svg) |
|:--:|
