...
|        ![Clock Cycle Count Beginnig](/article-images/blog/clock-cycle-count-1.png)         |
| :-------------------------------------------------------------------: |
...
|                                                                                                                                       ![FRI verifier inner loop](/article-images/blog/fri-inner-loop.png)                                                                                                                                       |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
...
|                        ![Clock Cycle Count Better](/article-images/blog/clock-cycle-count-2.png)                        |
| :------------------------------------------------------------------------------------------------: |
...
| ![Opstack Table Height Dominates](/article-images/blog/opstack-table-height-1.png) |
| :-----------------------------------------------------------: |
...
|                   ![After hand-optimizing the entire verifier](/article-images/blog/opstack-table-height-2.png)                   |
| :----------------------------------------------------------------------------------------------------------: |
