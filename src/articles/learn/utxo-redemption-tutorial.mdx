+++
title = "UTXO Redemption Tutorial"
description = "Step-by-step guide to building and using Neptune Core's redeem branch to generate UTXO redemption claims from the legacy chain."
author = "Jastar13 and Kaffin"
date = "2025-08-01"
type = "learn"
imagegen = "A tutorial interface showing UTXO redemption process with blockchain blocks and claim generation steps"

[thumbnail]
src = "/article-images/learn/ai/utxo-claim.jpeg"
caption = "UTXO Redemption Tutorial"
+++
...
3. Monitor the table on the bottom of the [UTXO redemption](/articles/utxo-redemption) page.
