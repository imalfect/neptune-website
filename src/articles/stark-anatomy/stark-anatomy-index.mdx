+++
title = "Anatomy of a STARK: Part 0"
description = "A six-part tutorial series explaining the mechanics of STARK proof systems for technically-inclined audiences."
author = "Alan Szepieniec"
date = "2021-10-28"
type = "learn"
imagegen = "Educational diagram showing the anatomy and structure of STARK cryptographic proof systems with labeled components"
weight = 7
[thumbnail]
src = "/article-images/learn/ai/stark-anatomy.jpeg"
...
{/*  more  */}
 ...
 - Part 0: Introduction
 - [Part 1: STARK Overview](/articles/stark-anatomy-overview)
 - [Part 2: Basic Tools](/articles/stark-anatomy-basic-tools)
 - [Part 3: FRI](/articles/stark-anatomy-fri)
 - [Part 4: The STARK Polynomial IOP](/articles/stark-anatomy-fri)
 - [Part 5: A Rescue-Prime STARK](/articles/stark-anatomy-rescue-prime)
 - [Part 6: Speeding Things Up](/articles/stark-anatomy-faster)
...
{<ArticleImage src="/article-images/learn/twitter-vitalik.png" type="table" centered={true} alt="Vitalik Buterin tweet about SNARKs" caption="Zk-SNARKs are expected to be a significant revolution." />}
...
{<ArticleImage src="/article-images/learn/twitter-eli.png" type="table" centered={true} alt="Eli Ben-Sasson tweet about STARKs" caption="STARKs will beat SNARKs" />}
