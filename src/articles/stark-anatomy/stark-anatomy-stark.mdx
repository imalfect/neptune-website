+++
title = "Anatomy of a STARK: Part 4"
description = "The STARK Polynomial IOP backbone, covering AIR arithmetization and interpolation steps for proof system construction."
author = "Alan Szepieniec"
date = "2021-10-28"
type = "learn"
imagegen = "Execution trace table with polynomial constraints showing AIR arithmetic intermediate representation"
weight = 3
[thumbnail]
src = "/article-images/learn/ai/execution-trace.jpeg"
...
{<ArticleImage src="/article-images/learn/stark-workflow.svg" type="table" centered={true} alt="Overview of the STARK workflow" />}
...
{<ArticleImage src="/article-images/learn/generalized-air-workflow.svg" type="table" centered={true} alt="STARK workflow for generalized AIR constraints" />}
...
[0](/articles/stark-anatomy-index) - [1](/articles/stark-anatomy-overview) - [2](/articles/stark-anatomy-basic-tools) - [3](/articles/stark-anatomy-fri) - **4** - [5](/articles/stark-anatomy-rescue-prime) - [6](/articles/stark-anatomy-faster)
