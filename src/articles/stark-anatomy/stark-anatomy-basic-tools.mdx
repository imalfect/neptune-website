+++
title = "Anatomy of a STARK: Part 2"
description = "Finite field arithmetic fundamentals and implementation for building STARKs with specific algebraic structures."
...
weight = 5
[thumbnail]
src = "/article-images/learn/ai/math-finite-field.jpeg"
...
{<ArticleImage src="/article-images/learn/interactive-proof.svg" type="table" centered={true} alt="Interactive proof before Fiat-Shamir transform" />}
...
{<ArticleImage src="/article-images/learn/proof-stream.svg" type="table" centered={true} alt="Non-interactive proof after Fiat-Shamir transform" />}
...
{<ArticleImage src="/article-images/learn/merkle-tree.svg" type="table" centered={true} alt="Merkle tree" />}
...
[0](/articles/stark-anatomy-index) - [1](/articles/stark-anatomy-overview) - **2** - [3](/articles/stark-anatomy-fri) - [4](/articles/stark-anatomy-stark) - [5](/articles/stark-anatomy-rescue-prime) - [6](/articles/stark-anatomy-faster)
