+++
title = "Anatomy of a STARK: Part 1"
description = "Overview of STARKs as hash-based interactive proof systems using AIR arithmetization and FRI for low-degree polynomial verification."
author = "Alan Szepieniec"
date = "2021-10-28"
type = "learn"
imagegen = "Diagram showing STARK proof system overview with hash functions, AIR, and FRI components connected"
weight = 6
[thumbnail]
src = "/article-images/learn/ai/stark.jpeg"
caption = "Anatomy of a STARK"
+++
...
{<ArticleImage src="/article-images/learn/pipeline.svg" type="table" centered={true} alt="Overview of the compilation pipeline for SNARKs" caption="The compilation pipeline is divisible into three transformation and four stages." />}
...
{<ArticleImage src="/article-images/learn/stark-overview.svg" type="table" centered={true} alt="Overview of the compilation pipeline for STARKs" caption="The STARK proof system revolves around the transformation of low-degree polynomials into new polynomials whose degree boundedness matches with the integrity of the computation." />}
...
[0](/articles/stark-anatomy-index) - **1** - [2](/articles/stark-anatomy-basic-tools) - [3](/articles/stark-anatomy-fri) - [4](/articles/stark-anatomy-stark) - [5](/articles/stark-anatomy-rescue-prime) - [6](/articles/stark-anatomy-faster)
