+++
title = "Anatomy of a STARK: Part 5"
description = "Building a practical STARK proof system for Rescue-Prime hash function evaluation, creating a post-quantum signature scheme."
author = "Alan Szepieniec"
date = "2021-10-28"
type = "learn"
imagegen = "Rescue-Prime hash function diagram showing sponge construction with round functions and STARK proof generation"
weight = 2
[thumbnail]
src = "/article-images/learn/ai/rescue-prime.jpeg"
...
{<ArticleImage src="/article-images/learn/rescue-prime-round.svg" type="table" centered={true} alt="Rescue-XLIX round function" />}
...
{<ArticleImage src="/article-images/learn/rescue-prime-sponge.svg" type="table" centered={true} alt="Rescue-Prime sponge construction" />}
...
[0](/articles/stark-anatomy-index) - [1](/articles/stark-anatomy-overview) - [2](/articles/stark-anatomy-basic-tools) - [3](/articles/stark-anatomy-fri) - [4](/articles/stark-anatomy-stark) - **5** - [6](/articles/stark-anatomy-faster)
