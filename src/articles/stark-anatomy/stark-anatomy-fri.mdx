+++
title = "Anatomy of a STARK: Part 3"
description = "FRI (Fast Reed-Solomon IOP of Proximity) protocol for establishing bounded polynomial degrees through split-and-fold technique."
author = "Alan Szepieniec"
date = "2021-10-28"
type = "learn"
imagegen = "Reed-Solomon codeword diagram with split-and-fold technique showing polynomial degree verification process"
weight = 4
[thumbnail]
src = "/article-images/learn/ai/reed-solomon.jpeg"
...
{<ArticleImage src="/article-images/learn/fri-overview.svg" type="table" centered={true} alt="FRI overview" />}
...
{<ArticleImage src="/article-images/learn/fri-attack.svg" type="table" centered={true} alt="Sampling indices in FRI - less secure vs more secure" caption="Sampling indices in FRI. Left: less secure; right: more secure." />}
...
[0](/articles/stark-anatomy-index) - [1](/articles/stark-anatomy-overview) - [2](/articles/stark-anatomy-basic-tools) - **3** - [4](/articles/stark-anatomy-stark) - [5](/articles/stark-anatomy-rescue-prime) - [6](/articles/stark-anatomy-faster)
